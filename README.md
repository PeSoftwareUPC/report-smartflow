...
|-----------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Comunica oralmente con efectividad a diferentes rangos de audiencia. | **Gongora Castillejos, Williams**<br>**TB1:** Durante la presentación de la problemática y la solución SmartFlow en la reunión del equipo, expuse claramente el perfil de la startup, los antecedentes y la propuesta técnica.<br><br>**Quiñones Tintaya, Johan Jorge**<br>**TB1:** Presentó el To-Be Scenario Mapping, User Stories, e Impact Mapping.<br><br>**Carlos Andres, Leon Rioja**<br>**TB1:** Expuso sobre la Information Architecture y el Landing Page UI Design.<br><br>**Revilla Quispe, Renzo Zamir**<br>**TB1:** Presentó el análisis comparativo de Web Applications UX/UI Design.<br><br>**Lopez de la Cruz Mauro Fabricio**<br>**TB1:** Comunicó las User Personas y el User Journey Mapping. | **Gongora Castillejos, Williams:** Mi presentación proporcionó una base clara sobre el perfil de la startup y la propuesta técnica, lo cual permitió al equipo entender el contexto y la dirección del proyecto. Esto facilitó una alineación efectiva en la toma de decisiones y en el establecimiento de objetivos claros para el desarrollo del proyecto.<br><br>**Quiñones Tintaya, Johan Jorge:** Al presentar el To-Be Scenario Mapping y User Stories, ayudé a visualizar el futuro del proyecto y a definir las expectativas de los usuarios. Esto permitió al equipo enfocar sus esfuerzos en las necesidades reales de los usuarios, facilitando una mejor planificación y ejecución.<br><br>**Carlos Andres, Leon Rioja:** Mi exposición sobre la arquitectura de información y el diseño UI de la landing page clarificó la estructura y el diseño visual del proyecto. Esto ayudó al equipo a entender cómo los usuarios interactuarían con el producto y a alinear el diseño con los objetivos del proyecto.<br><br>**Revilla Quispe, Renzo Zamir:** Mi análisis comparativo de diseños UX/UI proporcionó una visión valiosa sobre las mejores prácticas en la industria. Esto permitió al equipo aplicar estándares de calidad y evitar errores comunes, mejorando la usabilidad y la experiencia del usuario.<br><br>**Lopez de la Cruz Mauro Fabricio:** La comunicación de las User Personas y el User Journey Mapping facilitó una comprensión profunda de nuestros usuarios objetivo. Esto permitió diseñar soluciones más ajustadas a sus necesidades y comportamientos, optimizando la experiencia del usuario y asegurando que el producto fuera relevante y efectivo. |
| Comunica por escrito con efectividad a diferentes rangos de audiencia | **Gongora Castillejos, Williams**<br>**TB1:** Me encargué de redactar el Capítulo I del informe, que incluye los antecedentes, la problemática y el diseño de la base de datos. Asimismo, incluí las pautas para la elaboración de las tareas en el sprint 1.<br><br>**Quiñones Tintaya, Johan Jorge**<br>**TB1:** Documentó el Product Backlog y el Domain-Driven Software Architecture.<br><br>**Carlos Andres, Leon Rioja**<br>**TB1:** Elaboró la documentación del Landing Page Wireframe y Mock-up.<br><br>**Revilla Quispe, Renzo Zamir**<br>**TB1:** Redactó el análisis de competidores y el Class Diagram.<br><br>**Lopez de la Cruz Mauro Fabricio**<br>**TB1:** Documentó el User Task Matrix, Empathy Mapping, y As-is Scenario Mapping. | **Gongora Castillejos, Williams:** La redacción del Capítulo I proporcionó una base sólida para el informe al detallar claramente el contexto del proyecto y establecer directrices para las tareas del sprint. Esto facilitó una comprensión común entre los miembros del equipo y sentó las bases para un trabajo coordinado y efectivo.<br><br>**Quiñones Tintaya, Johan Jorge:** La documentación del Product Backlog y la arquitectura del software estructuró las tareas del proyecto y definió su base técnica. Esto permitió una planificación más precisa y una ejecución organizada, alineando las tareas con los objetivos del proyecto.<br><br>**Carlos Andres, Leon Rioja:** La documentación del wireframe y mock-up de la landing page proporcionó una representación visual del diseño. Esto facilitó la comunicación del diseño al equipo y a los stakeholders, y ayudó a definir claramente la apariencia y funcionalidad esperadas del producto.<br><br>**Revilla Quispe, Renzo Zamir:** Mi análisis de competidores y el diagrama de clases ofrecieron una visión profunda del mercado y la estructura del software. Esto proporcionó al equipo información valiosa para posicionar el producto y diseñar una solución técnica adecuada.<br><br>**Lopez de la Cruz Mauro Fabricio:** La documentación del User Task Matrix, Empathy Mapping y As-is Scenario Mapping ayudó a comprender las necesidades y comportamientos de los usuarios. Esto permitió diseñar soluciones centradas en el usuario, mejorando la relevancia del producto y asegurando que abordara eficazmente las necesidades del cliente. |
