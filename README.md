...
| 2  | US022          | Ver testimonios de clientes                  | Como visitante, quiero ver testimonios de otros clientes para evaluar la efectividad del producto.                            | 2            |
| 3  | US023          | Ver características y beneficios del producto| Como usuario potencial, quiero visualizar características y beneficios para comprender cómo puede mejorar mi negocio.         | 3            |
| 4  | US024          | Ver diferentes planes de precios             | Como usuario, quiero ver una comparación de los planes de precios disponibles.                                                | 2            |
| 5  | US025          | Animaciones Interactivas para Navegación     | Como usuario, quiero experimentar animaciones interactivas y fluidas para mejorar la experiencia de navegación.               | 3            |
| 6  | US001          | Ver dashboard de consumo total               | Como gerente de producción, quiero ver un dashboard con el consumo total de recursos en tiempo real.                         | 5            |
| 7  | US003          | Visualizar gráficos comparativos             | Como director financiero, quiero ver gráficos comparativos de consumo vs. producción.                                         | 5            |
| 8  | US004          | Filtrar datos de consumo por compañía        | Como analista, quiero poder filtrar los datos de consumo por fecha, máquina y tipo de recurso.                                | 5            |
| 9  | US005          | Mostrar resumen de consumo, costos y alarmas | Como gerente de operaciones, quiero visualizar un resumen de consumo, costos, eficiencia y alarmas.                           | 5            |
| 10 | US018          | Visualizar consumo personal                  | Como operario, quiero poder ver mi propio consumo de recursos durante mi turno.                                               | 3            |
| 11 | US027          | Filtrar trabajadores por compañía            | Como usuario, quiero un cuadro de filtrado donde pueda seleccionar una compañía para ver solo los trabajadores de esa compañía.| 5            |
| 12 | US028          | Mostrar lista de trabajadores                | Como usuario, quiero ver una lista de trabajadores con sus datos relevantes, como nombre, ocupación y edad.                   | 5            |
| 13 | US029          | Editar datos del trabajador                  | Como usuario, quiero un botón "Editar" para modificar los datos de los trabajadores.                                          | 5            |
| 14 | US030          | Guardar cambios de los datos del trabajador  | Como usuario, quiero poder guardar los cambios realizados en los datos del trabajador.                                        | 5            |
| 15 | US031          | Volver a la lista de trabajadores            | Como usuario, quiero poder volver a la lista de trabajadores después de editar los datos.                                     | 3            |
| 16 | US002          | Monitorear consumo en tiempo real            | Como operador de máquina, quiero ver el consumo en tiempo real de la máquina que estoy operando.                              | 5            |
| 17 | US006          | Generar informe de costos                    | Como contador, quiero acceder a un informe detallado de costos por recurso.                                                   | 5            |
| 18 | US007          | Calcular costo por unidad producida          | Como analista financiero, quiero calcular el costo de recursos por unidad producida.                                          | 5            |
| 19 | US008          | Proyectar costos futuros                     | Como director financiero, quiero proyectar los costos futuros basados en tendencias actuales.                                 | 8            |
| 20 | US009          | Comparar costos entre períodos               | Como gerente financiero, quiero comparar los costos entre diferentes períodos.                                                | 5            |
| 21 | US010          | Establecer alertas de costo                  | Como controller, quiero establecer alertas cuando los costos superen ciertos umbrales.                                        | 5            |
| 22 | US011          | Recibir alertas de consumo excesivo          | Como ingeniero de mantenimiento, quiero recibir alertas cuando el consumo de una máquina supere los límites establecidos.     | 3            |
| 23 | US012          | Configurar umbrales de alerta                | Como supervisor, quiero poder configurar los umbrales de alerta para diferentes máquinas y recursos.                          | 5            |
| 24 | US013          | Gestionar notificaciones                     | Como usuario, quiero poder gestionar mis preferencias de notificación para las alertas.                                       | 3            |
| 25 | US014          | Ver historial de alertas                     | Como gerente de mantenimiento, quiero ver un historial de todas las alertas generadas.                                        | 5            |
| 26 | US015          | Responder a alertas                          | Como técnico, quiero poder responder a las alertas y marcarlas como atendidas.                                                | 5            |
| 27 | US016          | Registrar turnos de trabajo                  | Como supervisor, quiero poder registrar los turnos de trabajo de cada empleado.                                               | 3            |
| 28 | US017          | Ver resumen de consumo por turno             | Como gerente de producción, quiero ver un resumen del consumo de recursos por turno y por empleado.                           | 5            |
| 29 | US019          | Comparar eficiencia entre turnos             | Como analista de RRHH, quiero comparar el consumo de recursos entre diferentes turnos y empleados.                            | 5            |
| 30 | US020          | Planificar turnos basados en eficiencia      | Como jefe de producción, quiero planificar los turnos basándome en la eficiencia histórica.                                   | 8            |
| 31 | US032          | Integrar con ERP                             | Como gerente de IT, quiero integrar el sistema de monitoreo de recursos con nuestro ERP.                                       | 8            |
| 32 | US033          | Conectar nuevos dispositivos IoT             | Como técnico de mantenimiento, quiero poder conectar nuevos dispositivos IoT al sistema de monitoreo.                         | 8            |
| 33 | US034          | Exportar datos a BI                          | Como analista de datos, quiero poder exportar datos de consumo a nuestra herramienta de BI.                                   | 5            |
| 34 | US035          | Acceder a API para desarrolladores           | Como desarrollador externo, quiero acceder a una API para integrar datos de consumo en aplicaciones de terceros.              | 8            |
| 35 | US036          | Sincronizar con sistema CMMS                 | Como jefe de mantenimiento, quiero sincronizar los datos de consumo y alertas con nuestro sistema CMMS.                       | 8            |
